import { extend, isObject } from './general'
...
const bodyColors: Record<Level, string> = {
  debug: '#fadb14',
  log: '#8c8c8c',
  info: '#52c41a',
  warn: '#fa8c16',
...
const levelMarks: Record<Level, string> = {
  debug: 'debug',
  log: 'log',
  info: 'info',
  warn: 'warn',
...
const outputFunction: Record<Level, any> = {
  debug: console.log,
  log: console.log,
  info: console.log,
  warn: console.warn,
...
const output = (logLevel: Level, bizName: string) => {
  return (...args: any[]) => {
    return outputFunction[logLevel].apply(
      console,
...
const getLogArgs = (args: any, bizName: string, logLevel: Level) => {
